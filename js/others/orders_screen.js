...
function initPage() {
    $("#nav_bar_orders").addClass("ui-btn-active");
    document.getElementById("past_orders_btn").style.background = "white";
    document.getElementById("past_orders_btn").style.color = "#00a99d";
...
function onSelectPastOrders() {
    $("#upcoming-empty-image").hide();

    document.getElementById("past_orders_btn").style.background = "white";
    document.getElementById("past_orders_btn").style.color = "#00a99d";
    document.getElementById("upcoming_orders_btn").style.background = "#00a99d";
    document.getElementById("upcoming_orders_btn").style.color = "white";
...
function onSelectUpcomingOrders() {
    $("#past-empty-image").hide();

    document.getElementById("upcoming_orders_btn").style.background = "white";
    document.getElementById("upcoming_orders_btn").style.color = "#00a99d";
    document.getElementById("past_orders_btn").style.background = "#00a99d";
    document.getElementById("past_orders_btn").style.color = "white";
